...
public class VentanaGestion extends JFrame {
	...
	private String path = "Mensajes.txt";
	 File fic = new File(path);//declara fichero
	...
	public VentanaGestion() {
		...
		btnCargar.setBounds(34, 41, 152, 31);
		...
		btnGuardar.setBounds(279, 40, 145, 32);
		...
		btnImp.setBounds(279, 93, 145, 31);
